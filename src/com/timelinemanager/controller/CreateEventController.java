...
public class CreateEventController {
	...
	public void initialize() throws IOException {
		...
		//ActionEvent for the create button inside the "Create new event" window
		...
		//ActionEvent for the add image label inside the "Create new event" window
      ...
      File file = fileChooser.showOpenDialog(null);
		...
		//ActionEvent for the cancel button inside the "Create new event" window
